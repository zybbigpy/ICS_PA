...
{add_i2rm_b, or_i2rm_b, adc_i2rm_b, sbb_i2rm_b, __ref_and_i2rm_b, sub_i2rm_b, xor_i2rm_b, cmp_i2rm_b};

/* 0x81 */
instr_func group_1_v_entry[8] =
{add_i2rm_v, or_i2rm_v, adc_i2rm_v,sbb_i2rm_v, __ref_and_i2rm_v, sub_i2rm_v, xor_i2rm_v, cmp_i2rm_v};
