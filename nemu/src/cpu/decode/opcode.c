...
/* 0x68 - 0x6b*/	inv, __ref_imul_irm2r_v, __ref_push_i_b, imul_i8rm2r_v,
...
/* 0xa8 - 0xab*/	__ref_test_i2a_b, __ref_test_i2a_v, stos_b, stos_v,
...
{add_i2rm_b, or_i2rm_b, adc_i2rm_b, sbb_i2rm_b, and_i2rm_b, sub_i2rm_b, __ref_xor_i2rm_b, __ref_cmp_i2rm_b};

/* 0x81 */
instr_func group_1_v_entry[8] =
{add_i2rm_v, or_i2rm_v, adc_i2rm_v, sbb_i2rm_v, and_i2rm_v, sub_i2rm_v, __ref_xor_i2rm_v, __ref_cmp_i2rm_v};
...
{__ref_test_i2rm_v, inv, not_rm_v, inv, mul_rm2a_v, imul_rm2a_v, div_rm2a_v, idiv_rm2a_v};

/* 0xff */
instr_func group_5_indirect_entry[8] =
{inc_rm_v, dec_rm_v, inv, inv, __ref_jmp_near_indirect, inv, __ref_push_rm_v, inv};
